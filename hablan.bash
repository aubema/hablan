...
/bin/sleep 20
# reset the gps
gpsctl -D 5 -x "\xB5\x62\x06\x04\x04\x00\xFF\x87\x00\x00\x94\xF5" /dev/ttyACM0
# set the gps to airborne < 1g mode
gpsctl -D 5 -x "\xB5\x62\x06\x24\x24\x00\xFF\x06\x03\x00\x00\x00\x00\x10\x27\x00\x00\x05\x00\xFA\x00\xFA\x00\x64\x00\x2C\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x16\xDC" /dev/ttyACM0
i=0
while [ $i -lt $nobs ]
